...
MyFORM.response = function (form, field){
	...
	var html = '<div class="row form-group-sm"> ' +
		...
		'<div class="col-sm-9"> ' +
		  '<textarea id="response" class="form-control input-sm" rows="5" disabled>Respond is active only if in form is field with name work if in form is field with name ' + field + '</textarea> ' +
		'</div> ' +
	'</div>';
	field = field || 'email';
