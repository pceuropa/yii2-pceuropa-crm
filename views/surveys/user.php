        ...
        'columns' => [
            ...
            'buttons' => [
		        'view' => function ($url, $model, $key) {
					return Html::a ( '<span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> ', ['surveys/view', 'url' => $model->url] );
				},
		        'list' => function ($url, $model, $key) {
					return Html::a ( '<span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> '.$model->answer, ['surveys/list', 'id' => $model->form_id] );
				},
		        'clone' => function ($url, $model, $key) {
					return Html::a ( 'clone', ['surveys/clone', 'id' => $model->form_id] );
				},
            ],
